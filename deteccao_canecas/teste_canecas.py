...
#imagem4 = cv2.imread('Imagens teste canecas/teste04.jpg')
...
#deteccoes1 = classificador1.detectMultiScale(imagemcinza1, scaleFactor= 1.2, minNeighbors=1, minSize=(30,30))
#deteccoes2 = classificador2.detectMultiScale(imagemcinza2, scaleFactor= 1.2, minNeighbors=1, minSize=(30,30))
deteccoes3 = classificador3.detectMultiScale(imagemcinza3, scaleFactor=1.55, minNeighbors=1, minSize=(30,30))
#deteccoes4 = classificador4.detectMultiScale(imagemcinza4, scaleFactor= 1.2, minNeighbors=1, minSize=(30,30))
...
#cv2.imshow('Detector de canecas1', imagem1)
#cv2.imshow('Detector de canecas2', imagem2)
cv2.imshow('Detector de canecas3', imagem3)
#cv2.imshow('Detector de canecas4', imagem4)
